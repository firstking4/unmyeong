...
**진행 (2026-09-05):** **S1 완료** — S1-b(키워드 표 E·F 승인, 5팩 v2, `meta.json` v2, `check:today-crosstab` 통과) + S1-c(결정 G, 칩 간격). `home` 팩은 S2에서. 결정 A~D 미확정. 다음은 S2.
...
브랜치 `feat/quality-s1-packs`에서 S1-b 완료. `main`에는 오늘 카드 칩 통일·허브 이동·라이트 테마·검사 스크립트가 커밋돼 있다(`a6548e4`).
S1-b: **saju · seonghyang · tarot · physiognomy · gunghap 팩 v2 전부 완료** (§3 「작업 순서 · 진행」). 이 브랜치를 `main`에 합치는 것은 사용자 판단.
